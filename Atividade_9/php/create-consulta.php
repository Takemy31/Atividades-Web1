...
<body>
    ...
    <form action="" method="post">
        ...
        <input type="date" name="data_consulta" id="data_consulta" required><br><br>

        <label for="hora_consulta">Hora: </label><br>
        <input type="time" name="hora_consulta" id="hora_consulta" required><br><br>

        <label for="observacao">Observação: </label><br>
        <textarea type="text" name="observacao" id="observacao" class="observacao"></textarea><br><br>
