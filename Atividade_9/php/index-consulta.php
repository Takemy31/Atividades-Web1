...
<body>
    <header>
        ...
        <a href="create-consulta.php">Adicionar Nova Consulta</a>
    </header>
    ...
    <?php if (!empty($consultas)): ?>
        ...
        <form action="export-consulta-pdf.php" method="GET" style="margin-top: 20px;">
                <input type="hidden" name="id" value="<?= $consulta['ID_CON'] ?>">
